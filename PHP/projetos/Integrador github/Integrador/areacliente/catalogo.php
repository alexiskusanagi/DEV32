...
<?php if(!isset($idcliente)){?>
        ...
        <div class='topo'>
            <h1>BEM VINDO AO KINDER HAUS</h1>
...
<?php }
        ...
        <div class="topo">    <!--abrindo o class topo -->
            ...
            <div class = "logout" method='post'><a href ='logout_cliente.php'><img src='../icons/backspace.png' width=50 height=45 ></a></div>
        </div>  
                     ...
                     <img src ='data:image/jpeg;base64,<?=$retorno[6]?>' width ="200" height ="200">
                        ...
                        <div class ='texto-card'> 
                                ...
                                <!-- USANDO GET BRABO pro botao alterar -->
                                        <a href='ver_servico.php?id=<?= $retorno[0]?>'><img src='../icons/zoom1.png' width=40 height=40 style='border: 2px solid rgba(224, 229, 231, 1) ; border-radius: 1px; margin: 2px;'></a>
